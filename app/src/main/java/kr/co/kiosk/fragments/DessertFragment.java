...
public class DessertFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i=0; i<10; i++){
            menuItems.add(new Menu("디저트", "5,500", "", R.drawable.ic_baseline_info_24));
        }
        ...
        menuAdapter.setItemClickListener(new RecyclerMenuAdapter.OnItemClickListener() {
            ...
            public void onImageClick(View view, int position) {
                ...
                for (int i=0; i<menuItems.size(); i++){
                    ((HomeActivity)HomeActivity.context_home).selectDessert.add(index, false);
                    index++;
                }

                if (((HomeActivity)HomeActivity.context_home).selectDessert.get(position)== false){
                    ...
                    ((HomeActivity)HomeActivity.context_home).selectDessert.set(position, true);
                }
